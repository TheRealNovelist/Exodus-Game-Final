...
namespace Old
{
    public abstract class GunBase : MonoBehaviour
    {
        ...
        protected GunData gunData; // a reference to class Gundata:ScriptableObject
        ...
        [Header("Key Binds")] protected KeyCode shootKey = KeyCode.Mouse0;
        ...
        protected IEnumerator Reload()
        {
            ...
            gunData.ammoNeedToReload = Mathf.Min(gunData.maxMagazineAmmo - gunData.currentAmmo,
                ammoManager.ammoPlayerCurrentHave);

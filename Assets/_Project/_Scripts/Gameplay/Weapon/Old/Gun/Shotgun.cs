...
namespace Old
{
    public class Shotgun : GunBase
    {
        ...
        void Update()
        {
            Debug.Log("I have " + ammoManager.ammoPlayerCurrentHave + " bullets, I have " + gunData.currentAmmo +
                      " bullets inside my gun");
        ...
        public override void Shoot()
        {
            ...
            for (int i = 0; i < gunData.gunPellets; i++)
            {
                ...
                Vector3
                    spread = Vector3
                        .zero; //create a angle for us to put random angle in it to make random shot for each pellets
                ...
                {
                    Debug.DrawLine(fpsCam.transform.position, fpsCam.transform.position + direction * gunData.gunRange,
                        Color.red, 3f);
                }
            }
